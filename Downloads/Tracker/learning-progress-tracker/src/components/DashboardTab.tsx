...
import { CriticalStylesFix } from './inline-styles';
import { 
  StyledClock, 
  StyledCheckCircle, 
  StyledBookOpen, 
...
import { DashboardIconStyles } from './DashboardIconStyles';
...
// Styles inline pour garantir les couleurs correctes en mode sombre
const iconStyles = {
  blue: { color: '#60a5fa', fill: 'none', strokeWidth: 2 },
  green: { color: '#34d399', fill: 'none', strokeWidth: 2 },
  purple: { color: '#a78bfa', fill: 'none', strokeWidth: 2 },
  amber: { color: '#fbbf24', fill: 'none', strokeWidth: 2 }
};
...
export function DashboardTab({ 
  ...
  // Détecte le mode sombre et met à jour l'état
  useEffect(() => {
    const checkDarkMode = () => {
  ...
  return (
    <div className="space-y-6 dashboard-container dashboard-root" id="dashboard-root" data-section="dashboard">
      {/* Ajout du composant qui injecte des styles critiques */}
      <CriticalStylesFix />
      <DashboardIconStyles />
      ...
      <div className="hidden md:flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <Button 
            ...
            onClick={() => setShowGoals(true)}
          >
            <StyledTarget className="h-4 w-4" /> Goals
          </Button>
          <Button 
            onClick={() => onAddItem(selectedDate)}
            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-sm"
      ...
      <div className="dashboard-cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="card from-blue-50 to-white bg-gradient-to-br rounded-xl p-4 border border-blue-200 shadow dark:from-blue-900 dark:to-blue-800 dark:border-blue-700">
          <div className="flex items-center">
            <div className="bg-blue-100 p-3 rounded-full dark:bg-blue-800">
              <StyledClock 
                className="h-6 w-6 text-blue-500 dashboard-icon blue-icon" 
                style={isDarkMode ? iconStyles.blue : undefined}
              />
            </div>
            <div>
        ...
        <div className="card from-green-50 to-white bg-gradient-to-br rounded-xl p-4 border border-green-200 shadow dark:from-green-900 dark:to-green-800 dark:border-green-700">
          <div className="flex items-center">
            <div className="bg-green-100 p-3 rounded-full dark:bg-green-800">
              <StyledCheckCircle 
                className="h-6 w-6 text-green-500 dashboard-icon green-icon" 
                style={isDarkMode ? iconStyles.green : undefined}
              />
            </div>
            <div>
        ...
        <div className="card from-purple-50 to-white bg-gradient-to-br rounded-xl p-4 border border-purple-200 shadow dark:from-purple-900 dark:to-purple-800 dark:border-purple-700">
          <div className="flex items-center">
            <div className="bg-purple-100 p-3 rounded-full dark:bg-purple-800">
              <StyledBookOpen 
                className="h-6 w-6 text-purple-500 dashboard-icon purple-icon" 
                style={isDarkMode ? iconStyles.purple : undefined}
              />
            </div>
            <div>
        ...
        <div className="card from-amber-50 to-white bg-gradient-to-br rounded-xl p-4 border border-amber-200 shadow dark:from-amber-900 dark:to-amber-800 dark:border-amber-700">
          <div className="flex items-center">
            <div className="bg-amber-100 p-3 rounded-full dark:bg-amber-800">
              <StyledTrophy 
                className="h-6 w-6 text-amber-500 dashboard-icon amber-icon" 
                style={isDarkMode ? iconStyles.amber : undefined}
              />
            </div>
            <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="md:col-span-1">
          <Card className="p-4 hover:shadow-md transition-shadow shadow-sm border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <div className="p-1.5 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                  <StyledClock className="w-5 h-5 text-blue-500 dark:text-blue-400" />
                </div>
            ...
            {activeTasks.length === 0 ? (
              <div className="text-center py-6">
                <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-full inline-block mb-3">
                  <StyledClock className="h-6 w-6 text-gray-400 dark:text-gray-500" />
                </div>
        ...
        <Card className="p-4 hover:shadow-md transition-shadow md:col-span-2 shadow-sm border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-green-50 dark:bg-green-900/30 rounded-lg">
                <StyledCheckCircle className="w-5 h-5 text-green-500 dark:text-green-400" />
              </div>
          ...
          {completedTasks.length === 0 ? (
            <div className="text-center py-6">
              <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-full inline-block mb-3">
                <StyledCheckCircle className="h-6 w-6 text-gray-400 dark:text-gray-500" />
              </div>
