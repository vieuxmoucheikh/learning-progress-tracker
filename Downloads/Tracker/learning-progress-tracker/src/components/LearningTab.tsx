...
export const LearningTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Ajout de classes spécifiques pour le texte d'introduction */}
      <p className="text-muted-foreground organize-text learning-description intro-paragraph light-visible-text">
        Organize and manage your learning notes with customizable cards.
      </p>
