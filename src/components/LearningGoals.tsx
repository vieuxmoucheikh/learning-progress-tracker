                  ...
                  <div className="rounded-md border shadow-md bg-background">
                    <Calendar
                      ...
                      classNames={{
                        ...
                        day_selected: "bg-blue-500 text-slate-50 hover:bg-blue-500 hover:text-slate-50 focus:bg-blue-500 focus:text-slate-50 dark:bg-blue-500 dark:text-slate-50 dark:hover:bg-blue-500 dark:hover:text-slate-50 dark:focus:bg-blue-500 dark:focus:text-slate-50",
