...
export function TabNavigation({ activeTab, onTabChange }: TabNavigationProps) {
  ...
  return (
    <div className="flex justify-center mb-8 border-b overflow-x-auto w-full">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex-shrink-0 text-sm font-medium py-4 px-3 border-b-2 flex items-center justify-center gap-2 transition-colors whitespace-nowrap",
                isActive
